...
# BEOD (Break at End of Day): fallback minimum work hours before the checkbox
# is offered and before +1h credit applies. Manager can override in Config.
BEOD_MINIMUM_HOURS = 5.0
